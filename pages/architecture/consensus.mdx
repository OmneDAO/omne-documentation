---
title: PoVERA Consensus
---

# PoVERA Consensus

**PoVERA** — Proof of Validated Execution & Resource Attestation — is Omne's dual-layer consensus protocol. It provides fast commerce-grade finality with periodic security-grade attestation.
