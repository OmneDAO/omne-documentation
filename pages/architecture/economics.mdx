...
Omne has two native tokens with **different decimal precision** — do not assume they match.

| Token | Base unit | Decimals | Relationship |
|---|---|---|---|
| **OMC** (commerce / gas) | Quar | 18 | 1 OMC = 10¹⁸ Quar (Quar is the smallest unit, like wei in Ethereum) |
| **OGT** (governance / staking) | gluu | 6 | 1 OGT = 10⁶ gluu |

Gas price is denominated in Quar. The default gas price is `1000` Quar. OGT amounts (staking, rewards) are denominated in gluu.
...
| Network | Stake range |
|---|---|
| **Ignis** devnet | 15–28 OGT |
| **Testum** testnet | [Pending](/notice/tokenomics-pending) |
| **Primum** mainnet | [Pending](/notice/tokenomics-pending) |
