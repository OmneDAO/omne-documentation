---
title: Key Storage Pattern
---

# Key Storage Pattern

This document describes the canonical key storage pattern used across all OmneDAO products (Phaylos wallet, foundation site, and any future frontends). The pattern provides **XSS-resilient mnemonic storage** using IndexedDB and the Web Crypto API.
...
All OmneDAO-provided products (Phaylos wallet, foundation site, explorer, future frontends) use this identical pattern. This ensures:
