...
A full node syncs the blockchain and serves RPC queries but does **not** participate in consensus or retain full receipt history.
...
| Feature | Full node | Archive node | Validator |
|---|---|---|---|
| Syncs chain | ✅ | ✅ | ✅ |
| Serves RPC | ✅ | ✅ | ✅ |
| Block production | ❌ | ❌ | ✅ |
| Full receipt history | ❌ (pruned) | ✅ | ❌ (pruned) |
| Disk requirements | Moderate | High (grows with chain) | Moderate |
